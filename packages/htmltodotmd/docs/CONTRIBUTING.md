...
1. Check [existing issues](https://github.com/andryushkin/dotmd-webcore/issues) — it may already be reported
2. Confirm you are on the latest version (`the version in package.json`)
...
Open an issue at: https://github.com/andryushkin/dotmd-webcore/issues

## Asking a question / suggesting a feature

Use [GitHub Discussions](https://github.com/andryushkin/dotmd-webcore/discussions) for questions. For feature requests, open an issue with the `enhancement` label.
...
```bash
git clone https://github.com/andryushkin/dotmd-webcore.git
cd dotmd-webcore
bun install
```
